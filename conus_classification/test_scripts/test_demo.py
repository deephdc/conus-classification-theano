...
from conus_classification.my_utils import single_prediction, test_predictions
from conus_classification.model_utils import load_model
from conus_classification.plot_utils import augmentation_demo, training_plots, test_plot
...
# Load training info
info_file = os.path.join(homedir, 'conus_classification', 'training_info', modelname + '.json')
...
# Load net weights
test_func = load_model(os.path.join(homedir, 'conus_classification', 'training_weights', modelname + '.npz'), output_dim=output_dim)
